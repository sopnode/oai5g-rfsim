    ...
    run_setup = [
        SshJob(
            ...
            command=[
                ...
                #Run("mkdir /opt/oai-gnb"),
                #Push(localpaths="gnb.sa.band66.fr1.106PRB.usrpn300.conf", remotepath="/opt/oai-gnb/mounted.conf"),
                ...
                Push(localpaths="gnb.band66.tm1.106PRB.usrpn300.conf", remotepath="/root/oai-cn5g-fed/charts/oai-5g-ran/oai-gnb/conf/mounted.conf"),
                ...
                Push(localpaths="deployment.yaml", remotepath="/root/oai-cn5g-fed/charts/oai-5g-ran/oai-gnb/templates/deployment.yaml"),
                Push(localpaths="values.yaml", remotepath="/root/oai-cn5g-fed/charts/oai-5g-ran/oai-gnb/values.yaml"),
